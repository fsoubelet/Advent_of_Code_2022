...
if __name__ == "__main__":
    sections = Path("input.txt").read_text().splitlines()

    # Part 1
    overlaps = 0
    for line in sections:
        elf1, elf2 = elf_sections(line)
    ...
    for line in sections:
        elf1, elf2 = elf_sections(line)
        if elf1.intersection(elf2):  # the intersection isn't empty
            overlaps += 1
